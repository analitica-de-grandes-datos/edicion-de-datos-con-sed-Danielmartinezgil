...
#
sed 's/,/./; s/;/,/; s/;/,/; s/;/,/' data.csv | sed 's/[a-z]/\U&/g' | sed 's/,N/,\\N/g' | sed 's/\N,,/\N,\\N,\\N/g'  | sed '6s/,,/,\\N,/; 6s/N/\N/' | sed '7s/\N,/\N,\\N/' | sed 's|\([0-9][0-9]\)/\([0-2][0-9]\)/\([0-9][0-9]\)|20\3-\2-\1|g' | sed 's|\([0-9]\)/\([0-9]\)/\([0-9][0-9][0-9][0-9]\)|\3-0\2-0\1|g' 